...
for k in range(1,10): # Nr de clusters e consequentemente eNodeBs
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,0,0.8))
    otimo_i0c08 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,0,0.9))
    otimo_i0c09 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,0,0.95))
    otimo_i0c095 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,0,0.98))
    otimo_i0c098 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,0,1))
    otimo_i0c1 = o[1]

    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,1,0.8))
    otimo_i1c08 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,1,0.9))
    otimo_i1c09 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,1,0.95))
    otimo_i1c095 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,1,0.98))
    otimo_i1c098 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,1,1))
    otimo_i1c1 = o[1]

    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,2,0.8))
    otimo_i2c08 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,2,0.9))
    otimo_i2c09 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,2,0.95))
    otimo_i2c095 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,2,0.98))
    otimo_i2c098 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,2,1))
    otimo_i2c1 = o[1]

    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,3,0.8))
    otimo_i3c08 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,3,0.9))
    otimo_i3c09 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,3,0.95))
    otimo_i3c095 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,3,0.98))
    otimo_i3c098 = o[1]
    o = np.loadtxt('result/Exato{}{}_i{}c{}.txt'.format(I,J,3,1))
    otimo_i3c1 = o[1]
    ...
    iteracoes = 30
    # time, bFit, nr_eNodeBs, nr_cliAtendidos, areaCoberta, sobrePos2, sobrePos3, sobrePos4, sobrePos5, sobrePos6, sobrePos7, sobrePos8, sobrePos9, PRD(20)
    result = np.zeros((iteracoes, 33))
    for it in range(iteracoes):
        ...
        result[it][13] = 100 * (otimo_i0c08  - result[it][1]) / abs(otimo_i0c08)     # PRD_i0c08
        result[it][14] = 100 * (otimo_i0c09  - result[it][1]) / abs(otimo_i0c09)     # PRD_i0c09
        result[it][15] = 100 * (otimo_i0c095 - result[it][1]) / abs(otimo_i0c095)    # PRD_i0c095
        result[it][16] = 100 * (otimo_i0c098 - result[it][1]) / abs(otimo_i0c098)    # PRD_i0c098
        result[it][17] = 100 * (otimo_i0c1   - result[it][1]) / abs(otimo_i0c1)      # PRD_i0c1

        result[it][18] = 100 * (otimo_i1c08  - result[it][1]) / abs(otimo_i1c08)     # PRD_i1c08
        result[it][19] = 100 * (otimo_i1c09  - result[it][1]) / abs(otimo_i1c09)     # PRD_i1c09
        result[it][20] = 100 * (otimo_i1c095 - result[it][1]) / abs(otimo_i1c095)    # PRD_i1c095
        result[it][21] = 100 * (otimo_i1c098 - result[it][1]) / abs(otimo_i1c098)    # PRD_i1c098
        result[it][22] = 100 * (otimo_i1c1   - result[it][1]) / abs(otimo_i1c1)      # PRD_i1c1

        result[it][23] = 100 * (otimo_i2c08  - result[it][1]) / abs(otimo_i2c08)     # PRD_i2c08
        result[it][24] = 100 * (otimo_i2c09  - result[it][1]) / abs(otimo_i2c09)     # PRD_i2c09
        result[it][25] = 100 * (otimo_i2c095 - result[it][1]) / abs(otimo_i2c095)    # PRD_i2c095
        result[it][26] = 100 * (otimo_i2c098 - result[it][1]) / abs(otimo_i2c098)    # PRD_i2c098
        result[it][27] = 100 * (otimo_i2c1   - result[it][1]) / abs(otimo_i2c1)      # PRD_i2c1

        result[it][28] = 100 * (otimo_i3c08  - result[it][1]) / abs(otimo_i3c08)     # PRD_i3c08
        result[it][29] = 100 * (otimo_i3c09  - result[it][1]) / abs(otimo_i3c09)     # PRD_i3c09
        result[it][30] = 100 * (otimo_i3c095 - result[it][1]) / abs(otimo_i3c095)    # PRD_i3c095
        result[it][31] = 100 * (otimo_i3c098 - result[it][1]) / abs(otimo_i3c098)    # PRD_i3c098
        result[it][32] = 100 * (otimo_i3c1   - result[it][1]) / abs(otimo_i3c1)      # PRD_i3c1
