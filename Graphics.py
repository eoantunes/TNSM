...
axs[0].bar(x - width,  E_overlap3Means[0],      width,                                                      color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_semOverlapMeans[0]+E_overlap2Means[0])
axs[0].bar(x - width,  E_overlap4Means[0],      width,                                                      color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_overlap2Means[0]+E_overlap3Means[0])
axs[0].bar(x - width,  E_overlap5Means[0],      width,                                                      color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_overlap2Means[0]+E_overlap3Means[0]+E_overlap4Means[0])
axs[0].bar(x - width,  E_overlap6Means[0],      width,                                                      color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_overlap2Means[0]+E_overlap3Means[0]+E_overlap4Means[0]+E_overlap5Means[0])
axs[0].bar(x - width,  E_overlap7Means[0],      width,                                                      color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_overlap2Means[0]+E_overlap3Means[0]+E_overlap4Means[0]+E_overlap5Means[0]+E_overlap6Means[0])
axs[0].bar(x - width,  E_overlap8Means[0],      width,                                                      color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_overlap2Means[0]+E_overlap3Means[0]+E_overlap4Means[0]+E_overlap5Means[0]+E_overlap6Means[0]+E_overlap7Means[0])
axs[0].bar(x - width,  E_overlap9Means[0],      width,                                                      color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_overlap2Means[0]+E_overlap3Means[0]+E_overlap4Means[0]+E_overlap5Means[0]+E_overlap6Means[0]+E_overlap7Means[0]+E_overlap8Means[0])
...
axs[0].bar(x ,         M_overlap4Means[0],      width, yerr=M_overlap4Std[0] ,                              color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0]+M_overlap2Means[0]+M_overlap3Means[0])
axs[0].bar(x ,         M_overlap5Means[0],      width, yerr=M_overlap5Std[0] ,                              color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0]+M_overlap2Means[0]+M_overlap3Means[0]+M_overlap4Means[0])
axs[0].bar(x ,         M_overlap6Means[0],      width, yerr=M_overlap6Std[0] ,                              color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0]+M_overlap2Means[0]+M_overlap3Means[0]+M_overlap4Means[0]+M_overlap5Means[0])
axs[0].bar(x ,         M_overlap7Means[0],      width, yerr=M_overlap7Std[0] ,                              color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0]+M_overlap2Means[0]+M_overlap3Means[0]+M_overlap4Means[0]+M_overlap5Means[0]+M_overlap6Means[0])
axs[0].bar(x ,         M_overlap8Means[0],      width, yerr=M_overlap8Std[0] ,                              color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0]+M_overlap2Means[0]+M_overlap3Means[0]+M_overlap4Means[0]+M_overlap5Means[0]+M_overlap6Means[0]+M_overlap7Means[0])
axs[0].bar(x ,         M_overlap9Means[0],      width, yerr=M_overlap9Std[0] ,                              color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0]+M_overlap2Means[0]+M_overlap3Means[0]+M_overlap4Means[0]+M_overlap5Means[0]+M_overlap6Means[0]+M_overlap7Means[0]+M_overlap8Means[0])
...
axs[0].bar(x + width,  H_overlap4Means[0],     width, yerr=H_overlap4Std[0] ,                               color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0]+H_overlap2Means[0]+H_overlap3Means[0])
axs[0].bar(x + width,  H_overlap5Means[0],     width, yerr=H_overlap5Std[0] ,                               color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0]+H_overlap2Means[0]+H_overlap3Means[0]+H_overlap4Means[0])
axs[0].bar(x + width,  H_overlap6Means[0],     width, yerr=H_overlap6Std[0] ,                               color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0]+H_overlap2Means[0]+H_overlap3Means[0]+H_overlap4Means[0]+H_overlap5Means[0])
axs[0].bar(x + width,  H_overlap7Means[0],     width, yerr=H_overlap7Std[0] ,                               color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0]+H_overlap2Means[0]+H_overlap3Means[0]+H_overlap4Means[0]+H_overlap5Means[0]+H_overlap6Means[0])
axs[0].bar(x + width,  H_overlap8Means[0],     width, yerr=H_overlap8Std[0] ,                               color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0]+H_overlap2Means[0]+H_overlap3Means[0]+H_overlap4Means[0]+H_overlap5Means[0]+H_overlap6Means[0]+H_overlap7Means[0])
axs[0].bar(x + width,  H_overlap9Means[0],     width, yerr=H_overlap9Std[0] ,                               color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0]+H_overlap2Means[0]+H_overlap3Means[0]+H_overlap4Means[0]+H_overlap5Means[0]+H_overlap6Means[0]+H_overlap7Means[0]+H_overlap8Means[0])
...
axs[1].bar(x - width,  E_overlap3Means[1],      width,                                                      color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1])
axs[1].bar(x - width,  E_overlap4Means[1],      width,                                                      color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1]+E_overlap3Means[1])
axs[1].bar(x - width,  E_overlap5Means[1],      width,                                                      color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1]+E_overlap3Means[1]+E_overlap4Means[1])
axs[1].bar(x - width,  E_overlap6Means[1],      width,                                                      color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1]+E_overlap3Means[1]+E_overlap4Means[1]+E_overlap5Means[1])
axs[1].bar(x - width,  E_overlap7Means[1],      width,                                                      color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1]+E_overlap3Means[1]+E_overlap4Means[1]+E_overlap5Means[1]+E_overlap6Means[1])
axs[1].bar(x - width,  E_overlap8Means[1],      width,                                                      color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1]+E_overlap3Means[1]+E_overlap4Means[1]+E_overlap5Means[1]+E_overlap6Means[1]+E_overlap7Means[1])
axs[1].bar(x - width,  E_overlap9Means[1],      width,                                                      color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1]+E_overlap3Means[1]+E_overlap4Means[1]+E_overlap5Means[1]+E_overlap6Means[1]+E_overlap7Means[1]+E_overlap8Means[1])
...
axs[1].bar(x ,         M_overlap3Means[1],      width, yerr=M_overlap3Std[1] ,                              color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1])
axs[1].bar(x ,         M_overlap4Means[1],      width, yerr=M_overlap4Std[1] ,                              color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1]+M_overlap3Means[1])
axs[1].bar(x ,         M_overlap5Means[1],      width, yerr=M_overlap5Std[1] ,                              color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1]+M_overlap3Means[1]+M_overlap4Means[1])
axs[1].bar(x ,         M_overlap6Means[1],      width, yerr=M_overlap6Std[1] ,                              color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1]+M_overlap3Means[1]+M_overlap4Means[1]+M_overlap5Means[1])
axs[1].bar(x ,         M_overlap7Means[1],      width, yerr=M_overlap7Std[1] ,                              color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1]+M_overlap3Means[1]+M_overlap4Means[1]+M_overlap5Means[1]+M_overlap6Means[1])
axs[1].bar(x ,         M_overlap8Means[1],      width, yerr=M_overlap8Std[1] ,                              color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1]+M_overlap3Means[1]+M_overlap4Means[1]+M_overlap5Means[1]+M_overlap6Means[1]+M_overlap7Means[1])
axs[1].bar(x ,         M_overlap9Means[1],      width, yerr=M_overlap9Std[1] ,                              color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1]+M_overlap3Means[1]+M_overlap4Means[1]+M_overlap5Means[1]+M_overlap6Means[1]+M_overlap7Means[1]+M_overlap8Means[1])
...
axs[1].bar(x + width,  H_overlap3Means[1],     width, yerr=H_overlap3Std[1] ,                               color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1])
axs[1].bar(x + width,  H_overlap4Means[1],     width, yerr=H_overlap4Std[1] ,                               color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1]+H_overlap3Means[1])
axs[1].bar(x + width,  H_overlap5Means[1],     width, yerr=H_overlap5Std[1] ,                               color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1]+H_overlap3Means[1]+H_overlap4Means[1])
axs[1].bar(x + width,  H_overlap6Means[1],     width, yerr=H_overlap6Std[1] ,                               color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1]+H_overlap3Means[1]+H_overlap4Means[1]+H_overlap5Means[1])
axs[1].bar(x + width,  H_overlap7Means[1],     width, yerr=H_overlap7Std[1] ,                               color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1]+H_overlap3Means[1]+H_overlap4Means[1]+H_overlap5Means[1]+H_overlap6Means[1])
axs[1].bar(x + width,  H_overlap8Means[1],     width, yerr=H_overlap8Std[1] ,                               color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1]+H_overlap3Means[1]+H_overlap4Means[1]+H_overlap5Means[1]+H_overlap6Means[1]+H_overlap7Means[1])
axs[1].bar(x + width,  H_overlap9Means[1],     width, yerr=H_overlap9Std[1] ,                               color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1]+H_overlap3Means[1]+H_overlap4Means[1]+H_overlap5Means[1]+H_overlap6Means[1]+H_overlap7Means[1]+H_overlap8Means[1])
...
axs[2].bar(x - width,  E_overlap3Means[2],      width,                                                      color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2])
axs[2].bar(x - width,  E_overlap4Means[2],      width,                                                      color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2]+E_overlap3Means[2])
axs[2].bar(x - width,  E_overlap5Means[2],      width,                                                      color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2]+E_overlap3Means[2]+E_overlap4Means[2])
axs[2].bar(x - width,  E_overlap6Means[2],      width,                                                      color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2]+E_overlap3Means[2]+E_overlap4Means[2]+E_overlap5Means[2])
axs[2].bar(x - width,  E_overlap7Means[2],      width,                                                      color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2]+E_overlap3Means[2]+E_overlap4Means[2]+E_overlap5Means[2]+E_overlap6Means[2])
axs[2].bar(x - width,  E_overlap8Means[2],      width,                                                      color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2]+E_overlap3Means[2]+E_overlap4Means[2]+E_overlap5Means[2]+E_overlap6Means[2]+E_overlap7Means[2])
axs[2].bar(x - width,  E_overlap9Means[2],      width,                                                      color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2]+E_overlap3Means[2]+E_overlap4Means[2]+E_overlap5Means[2]+E_overlap6Means[2]+E_overlap7Means[2]+E_overlap8Means[2])
...
axs[2].bar(x ,         M_overlap3Means[2],      width, yerr=M_overlap3Std[2] ,                              color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2])
axs[2].bar(x ,         M_overlap4Means[2],      width, yerr=M_overlap4Std[2] ,                              color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2]+M_overlap3Means[2])
axs[2].bar(x ,         M_overlap5Means[2],      width, yerr=M_overlap5Std[2] ,                              color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2]+M_overlap3Means[2]+M_overlap4Means[2])
axs[2].bar(x ,         M_overlap6Means[2],      width, yerr=M_overlap6Std[2] ,                              color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2]+M_overlap3Means[2]+M_overlap4Means[2]+M_overlap5Means[2])
axs[2].bar(x ,         M_overlap7Means[2],      width, yerr=M_overlap7Std[2] ,                              color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2]+M_overlap3Means[2]+M_overlap4Means[2]+M_overlap5Means[2]+M_overlap6Means[2])
axs[2].bar(x ,         M_overlap8Means[2],      width, yerr=M_overlap8Std[2] ,                              color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2]+M_overlap3Means[2]+M_overlap4Means[2]+M_overlap5Means[2]+M_overlap6Means[2]+M_overlap7Means[2])
axs[2].bar(x ,         M_overlap9Means[2],      width, yerr=M_overlap9Std[2] ,                              color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2]+M_overlap3Means[2]+M_overlap4Means[2]+M_overlap5Means[2]+M_overlap6Means[2]+M_overlap7Means[2]+M_overlap8Means[2])
...
axs[2].bar(x + width,  H_overlap3Means[2],     width, yerr=H_overlap3Std[2] ,                               color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2])
axs[2].bar(x + width,  H_overlap4Means[2],     width, yerr=H_overlap4Std[2] ,                               color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2]+H_overlap3Means[2])
axs[2].bar(x + width,  H_overlap5Means[2],     width, yerr=H_overlap5Std[2] ,                               color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2]+H_overlap3Means[2]+H_overlap4Means[2])
axs[2].bar(x + width,  H_overlap6Means[2],     width, yerr=H_overlap6Std[2] ,                               color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2]+H_overlap3Means[2]+H_overlap4Means[2]+H_overlap5Means[2])
axs[2].bar(x + width,  H_overlap7Means[2],     width, yerr=H_overlap7Std[2] ,                               color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2]+H_overlap3Means[2]+H_overlap4Means[2]+H_overlap5Means[2]+H_overlap6Means[2])
axs[2].bar(x + width,  H_overlap8Means[2],     width, yerr=H_overlap8Std[2] ,                               color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2]+H_overlap3Means[2]+H_overlap4Means[2]+H_overlap5Means[2]+H_overlap6Means[2]+H_overlap7Means[2])
axs[2].bar(x + width,  H_overlap9Means[2],     width, yerr=H_overlap9Std[2] ,                               color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2]+H_overlap3Means[2]+H_overlap4Means[2]+H_overlap5Means[2]+H_overlap6Means[2]+H_overlap7Means[2]+H_overlap8Means[2])
...
axs[3].bar(x - width,  E_overlap3Means[3],      width,                                                      color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3])
axs[3].bar(x - width,  E_overlap4Means[3],      width,                                                      color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3]+E_overlap3Means[3])
axs[3].bar(x - width,  E_overlap5Means[3],      width,                                                      color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3]+E_overlap3Means[3]+E_overlap4Means[3])
axs[3].bar(x - width,  E_overlap6Means[3],      width,                                                      color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3]+E_overlap3Means[3]+E_overlap4Means[3]+E_overlap5Means[3])
axs[3].bar(x - width,  E_overlap7Means[3],      width,                                                      color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3]+E_overlap3Means[3]+E_overlap4Means[3]+E_overlap5Means[3]+E_overlap6Means[3])
axs[3].bar(x - width,  E_overlap8Means[3],      width,                                                      color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3]+E_overlap3Means[3]+E_overlap4Means[3]+E_overlap5Means[3]+E_overlap6Means[3]+E_overlap7Means[3])
axs[3].bar(x - width,  E_overlap9Means[3],      width,                                                      color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3]+E_overlap3Means[3]+E_overlap4Means[3]+E_overlap5Means[3]+E_overlap6Means[3]+E_overlap7Means[3]+E_overlap8Means[3])
...
axs[3].bar(x ,         M_overlap3Means[3],      width, yerr=M_overlap3Std[3] ,                              color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3])
axs[3].bar(x ,         M_overlap4Means[3],      width, yerr=M_overlap4Std[3] ,                              color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3]+M_overlap3Means[3])
axs[3].bar(x ,         M_overlap5Means[3],      width, yerr=M_overlap5Std[3] ,                              color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3]+M_overlap3Means[3]+M_overlap4Means[3])
axs[3].bar(x ,         M_overlap6Means[3],      width, yerr=M_overlap6Std[3] ,                              color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3]+M_overlap3Means[3]+M_overlap4Means[3]+M_overlap5Means[3])
axs[3].bar(x ,         M_overlap7Means[3],      width, yerr=M_overlap7Std[3] ,                              color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3]+M_overlap3Means[3]+M_overlap4Means[3]+M_overlap5Means[3]+M_overlap6Means[3])
axs[3].bar(x ,         M_overlap8Means[3],      width, yerr=M_overlap8Std[3] ,                              color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3]+M_overlap3Means[3]+M_overlap4Means[3]+M_overlap5Means[3]+M_overlap6Means[3]+M_overlap7Means[3])
axs[3].bar(x ,         M_overlap9Means[3],      width, yerr=M_overlap9Std[3] ,                              color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3]+M_overlap3Means[3]+M_overlap4Means[3]+M_overlap5Means[3]+M_overlap6Means[3]+M_overlap7Means[3]+M_overlap8Means[3])
...
axs[3].bar(x + width,  H_overlap3Means[3],     width, yerr=H_overlap3Std[3] ,                               color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3])
axs[3].bar(x + width,  H_overlap4Means[3],     width, yerr=H_overlap4Std[3] ,                               color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3]+H_overlap3Means[3])
axs[3].bar(x + width,  H_overlap5Means[3],     width, yerr=H_overlap5Std[3] ,                               color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3]+H_overlap3Means[3]+H_overlap4Means[3])
axs[3].bar(x + width,  H_overlap6Means[3],     width, yerr=H_overlap6Std[3] ,                               color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3]+H_overlap3Means[3]+H_overlap4Means[3]+H_overlap5Means[3])
axs[3].bar(x + width,  H_overlap7Means[3],     width, yerr=H_overlap7Std[3] ,                               color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3]+H_overlap3Means[3]+H_overlap4Means[3]+H_overlap5Means[3]+H_overlap6Means[3])
axs[3].bar(x + width,  H_overlap8Means[3],     width, yerr=H_overlap8Std[3] ,                               color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3]+H_overlap3Means[3]+H_overlap4Means[3]+H_overlap5Means[3]+H_overlap6Means[3]+H_overlap7Means[3])
axs[3].bar(x + width,  H_overlap9Means[3],     width, yerr=H_overlap9Std[3] ,                               color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3]+H_overlap3Means[3]+H_overlap4Means[3]+H_overlap5Means[3]+H_overlap6Means[3]+H_overlap7Means[3]+H_overlap8Means[3])
