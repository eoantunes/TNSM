...
###   Cenário Brum1215
axs[0].bar(x - width,  E_semOverlapMeans[0],    width,                          label='E-ALLOCATOR',    color='#15B01A', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7)
axs[0].bar(x - width,  E_overlap2Means[0],      width,                                                  color='#FFFF14', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0])
axs[0].bar(x - width,  E_overlap3Means[0],      width,                          label='E-ALLOCATOR',    color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_overlap2Means[0])
#axs[0].bar(x - width,  E_overlap4Means[0],      width, yerr=exact_timeStd[0],  label='E-ALLOCATOR',    color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_overlap2Means[0]+E_overlap3Means[0])
#axs[0].bar(x - width,  E_overlap5Means[0],      width, yerr=exact_timeStd[0],  label='E-ALLOCATOR',    color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_overlap2Means[0]+E_overlap3Means[0]+E_overlap4Means[0])
#axs[0].bar(x - width,  E_overlap6Means[0],      width, yerr=exact_timeStd[0],  label='E-ALLOCATOR',    color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_overlap2Means[0]+E_overlap3Means[0]+E_overlap4Means[0]+E_overlap5Means[0])
#axs[0].bar(x - width,  E_overlap7Means[0],      width, yerr=exact_timeStd[0],  label='E-ALLOCATOR',    color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_overlap2Means[0]+E_overlap3Means[0]+E_overlap4Means[0]+E_overlap5Means[0]+E_overlap6Means[0])
#axs[0].bar(x - width,  E_overlap8Means[0],      width, yerr=exact_timeStd[0],  label='E-ALLOCATOR',    color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_overlap2Means[0]+E_overlap3Means[0]+E_overlap4Means[0]+E_overlap5Means[0]+E_overlap6Means[0]+E_overlap7Means[0])
#axs[0].bar(x - width,  E_overlap9Means[0],      width, yerr=exact_timeStd[0],  label='E-ALLOCATOR',    color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[0]+E_overlap2Means[0]+E_overlap3Means[0]+E_overlap4Means[0]+E_overlap5Means[0]+E_overlap6Means[0]+E_overlap7Means[0]+E_overlap8Means[0])

axs[0].bar(x ,         M_semOverlapMeans[0],    width, yerr=M_semOverlapStd[0] ,    label='M-ALLOCATOR',    color='#15B01A', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7)
axs[0].bar(x ,         M_overlap2Means[0],      width, yerr=M_overlap2Std[0] ,                              color='#FFFF14', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0])
axs[0].bar(x ,         M_overlap3Means[0],      width, yerr=M_overlap3Std[0] ,                              color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0]+M_overlap2Means[0])
#axs[0].bar(x ,         M_overlap4Means[0],      width, yerr=ga_timeStd[0] ,    label='M-ALLOCATOR',    color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0]+M_overlap2Means[0]+M_overlap3Means[0])
#axs[0].bar(x ,         M_overlap5Means[0],      width, yerr=ga_timeStd[0] ,    label='M-ALLOCATOR',    color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0]+M_overlap2Means[0]+M_overlap3Means[0]+M_overlap4Means[0])
#axs[0].bar(x ,         M_overlap6Means[0],      width, yerr=ga_timeStd[0] ,    label='M-ALLOCATOR',    color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0]+M_overlap2Means[0]+M_overlap3Means[0]+M_overlap4Means[0]+M_overlap5Means[0])
#axs[0].bar(x ,         M_overlap7Means[0],      width, yerr=ga_timeStd[0] ,    label='M-ALLOCATOR',    color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0]+M_overlap2Means[0]+M_overlap3Means[0]+M_overlap4Means[0]+M_overlap5Means[0]+M_overlap6Means[0])
#axs[0].bar(x ,         M_overlap8Means[0],      width, yerr=ga_timeStd[0] ,    label='M-ALLOCATOR',    color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0]+M_overlap2Means[0]+M_overlap3Means[0]+M_overlap4Means[0]+M_overlap5Means[0]+M_overlap6Means[0]+M_overlap7Means[0])
#axs[0].bar(x ,         M_overlap9Means[0],      width, yerr=ga_timeStd[0] ,    label='M-ALLOCATOR',    color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[0]+M_overlap2Means[0]+M_overlap3Means[0]+M_overlap4Means[0]+M_overlap5Means[0]+M_overlap6Means[0]+M_overlap7Means[0]+M_overlap8Means[0])

axs[0].bar(x + width,  H_semOverlapMeans[0],   width, yerr=H_semOverlapStd[0] ,  label='Heuristic',     color='#15B01A', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7)
axs[0].bar(x + width,  H_overlap2Means[0],     width, yerr=H_overlap2Std[0] ,                           color='#FFFF14', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0])
axs[0].bar(x + width,  H_overlap3Means[0],     width, yerr=H_overlap3Std[0] ,                           color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0]+H_overlap2Means[0])
#axs[0].bar(x + width,  H_overlap4Means[0],     width, yerr=heur_timeStd[0] ,  label='Heuristic',    color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0]+H_overlap2Means[0]+H_overlap3Means[0])
#axs[0].bar(x + width,  H_overlap5Means[0],     width, yerr=heur_timeStd[0] ,  label='Heuristic',    color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0]+H_overlap2Means[0]+H_overlap3Means[0]+H_overlap4Means[0])
#axs[0].bar(x + width,  H_overlap6Means[0],     width, yerr=heur_timeStd[0] ,  label='Heuristic',    color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0]+H_overlap2Means[0]+H_overlap3Means[0]+H_overlap4Means[0]+H_overlap5Means[0])
#axs[0].bar(x + width,  H_overlap7Means[0],     width, yerr=heur_timeStd[0] ,  label='Heuristic',    color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0]+H_overlap2Means[0]+H_overlap3Means[0]+H_overlap4Means[0]+H_overlap5Means[0]+H_overlap6Means[0])
#axs[0].bar(x + width,  H_overlap8Means[0],     width, yerr=heur_timeStd[0] ,  label='Heuristic',    color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0]+H_overlap2Means[0]+H_overlap3Means[0]+H_overlap4Means[0]+H_overlap5Means[0]+H_overlap6Means[0]+H_overlap7Means[0])
#axs[0].bar(x + width,  H_overlap9Means[0],     width, yerr=heur_timeStd[0] ,  label='Heuristic',    color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[0]+H_overlap2Means[0]+H_overlap3Means[0]+H_overlap4Means[0]+H_overlap5Means[0]+H_overlap6Means[0]+H_overlap7Means[0]+H_overlap8Means[0])


###   Cenário Brum2025   ###
axs[1].bar(x - width,  E_semOverlapMeans[1],    width,                         label='E-ALLOCATOR',    color='#15B01A', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7)
axs[1].bar(x - width,  E_overlap2Means[1],      width,                                                 color='#FFFF14', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1])
#axs[1].bar(x - width,  E_overlap3Means[1],      width, yerr=exact_timeStd[1],  label='E-ALLOCATOR',    color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1])
#axs[1].bar(x - width,  E_overlap4Means[1],      width, yerr=exact_timeStd[1],  label='E-ALLOCATOR',    color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1]+E_overlap3Means[1])
#axs[1].bar(x - width,  E_overlap5Means[1],      width, yerr=exact_timeStd[1],  label='E-ALLOCATOR',    color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1]+E_overlap3Means[1]+E_overlap4Means[1])
#axs[1].bar(x - width,  E_overlap6Means[1],      width, yerr=exact_timeStd[1],  label='E-ALLOCATOR',    color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1]+E_overlap3Means[1]+E_overlap4Means[1]+E_overlap5Means[1])
#axs[1].bar(x - width,  E_overlap7Means[1],      width, yerr=exact_timeStd[1],  label='E-ALLOCATOR',    color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1]+E_overlap3Means[1]+E_overlap4Means[1]+E_overlap5Means[1]+E_overlap6Means[1])
#axs[1].bar(x - width,  E_overlap8Means[1],      width, yerr=exact_timeStd[1],  label='E-ALLOCATOR',    color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1]+E_overlap3Means[1]+E_overlap4Means[1]+E_overlap5Means[1]+E_overlap6Means[1]+E_overlap7Means[1])
#axs[1].bar(x - width,  E_overlap9Means[1],      width, yerr=exact_timeStd[1],  label='E-ALLOCATOR',    color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[1]+E_overlap2Means[1]+E_overlap3Means[1]+E_overlap4Means[1]+E_overlap5Means[1]+E_overlap6Means[1]+E_overlap7Means[1]+E_overlap8Means[1])

axs[1].bar(x ,         M_semOverlapMeans[1],    width, yerr=M_semOverlapStd[1] ,    label='M-ALLOCATOR',    color='#15B01A', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7)
axs[1].bar(x ,         M_overlap2Means[1],      width, yerr=M_overlap2Std[1] ,                              color='#FFFF14', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1])
#axs[1].bar(x ,         M_overlap3Means[1],      width, yerr=ga_timeStd[1] ,    label='M-ALLOCATOR',    color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1])
#axs[1].bar(x ,         M_overlap4Means[1],      width, yerr=ga_timeStd[1] ,    label='M-ALLOCATOR',    color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1]+M_overlap3Means[1])
#axs[1].bar(x ,         M_overlap5Means[1],      width, yerr=ga_timeStd[1] ,    label='M-ALLOCATOR',    color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1]+M_overlap3Means[1]+M_overlap4Means[1])
#axs[1].bar(x ,         M_overlap6Means[1],      width, yerr=ga_timeStd[1] ,    label='M-ALLOCATOR',    color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1]+M_overlap3Means[1]+M_overlap4Means[1]+M_overlap5Means[1])
#axs[1].bar(x ,         M_overlap7Means[1],      width, yerr=ga_timeStd[1] ,    label='M-ALLOCATOR',    color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1]+M_overlap3Means[1]+M_overlap4Means[1]+M_overlap5Means[1]+M_overlap6Means[1])
#axs[1].bar(x ,         M_overlap8Means[1],      width, yerr=ga_timeStd[1] ,    label='M-ALLOCATOR',    color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1]+M_overlap3Means[1]+M_overlap4Means[1]+M_overlap5Means[1]+M_overlap6Means[1]+M_overlap7Means[1])
#axs[1].bar(x ,         M_overlap9Means[1],      width, yerr=ga_timeStd[1] ,    label='M-ALLOCATOR',    color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[1]+M_overlap2Means[1]+M_overlap3Means[1]+M_overlap4Means[1]+M_overlap5Means[1]+M_overlap6Means[1]+M_overlap7Means[1]+M_overlap8Means[1])

axs[1].bar(x + width,  H_semOverlapMeans[1],   width, yerr=H_semOverlapStd[1] ,  label='Heuristic',    color='#15B01A', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7)
axs[1].bar(x + width,  H_overlap2Means[1],     width, yerr=H_overlap2Std[1] ,                          color='#FFFF14', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1])
#axs[1].bar(x + width,  H_overlap3Means[1],     width, yerr=heur_timeStd[1] ,  label='Heuristic',    color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1])
#axs[1].bar(x + width,  H_overlap4Means[1],     width, yerr=heur_timeStd[1] ,  label='Heuristic',    color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1]+H_overlap3Means[1])
#axs[1].bar(x + width,  H_overlap5Means[1],     width, yerr=heur_timeStd[1] ,  label='Heuristic',    color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1]+H_overlap3Means[1]+H_overlap4Means[1])
#axs[1].bar(x + width,  H_overlap6Means[1],     width, yerr=heur_timeStd[1] ,  label='Heuristic',    color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1]+H_overlap3Means[1]+H_overlap4Means[1]+H_overlap5Means[1])
#axs[1].bar(x + width,  H_overlap7Means[1],     width, yerr=heur_timeStd[1] ,  label='Heuristic',    color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1]+H_overlap3Means[1]+H_overlap4Means[1]+H_overlap5Means[1]+H_overlap6Means[1])
#axs[1].bar(x + width,  H_overlap8Means[1],     width, yerr=heur_timeStd[1] ,  label='Heuristic',    color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1]+H_overlap3Means[1]+H_overlap4Means[1]+H_overlap5Means[1]+H_overlap6Means[1]+H_overlap7Means[1])
#axs[1].bar(x + width,  H_overlap9Means[1],     width, yerr=heur_timeStd[1] ,  label='Heuristic',    color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[1]+H_overlap2Means[1]+H_overlap3Means[1]+H_overlap4Means[1]+H_overlap5Means[1]+H_overlap6Means[1]+H_overlap7Means[1]+H_overlap8Means[1])


###   Cenário Brum2430   ###
axs[2].bar(x - width,  E_semOverlapMeans[2],    width,                         label='E-ALLOCATOR',    color='#15B01A', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7)
axs[2].bar(x - width,  E_overlap2Means[2],      width,                                                 color='#FFFF14', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2])
#axs[2].bar(x - width,  E_overlap3Means[2],      width, yerr=exact_timeStd[2],  label='E-ALLOCATOR',    color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2])
#axs[2].bar(x - width,  E_overlap4Means[2],      width, yerr=exact_timeStd[2],  label='E-ALLOCATOR',    color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2]+E_overlap3Means[2])
#axs[2].bar(x - width,  E_overlap5Means[2],      width, yerr=exact_timeStd[2],  label='E-ALLOCATOR',    color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2]+E_overlap3Means[2]+E_overlap4Means[2])
#axs[2].bar(x - width,  E_overlap6Means[2],      width, yerr=exact_timeStd[2],  label='E-ALLOCATOR',    color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2]+E_overlap3Means[2]+E_overlap4Means[2]+E_overlap5Means[2])
#axs[2].bar(x - width,  E_overlap7Means[2],      width, yerr=exact_timeStd[2],  label='E-ALLOCATOR',    color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2]+E_overlap3Means[2]+E_overlap4Means[2]+E_overlap5Means[2]+E_overlap6Means[2])
#axs[2].bar(x - width,  E_overlap8Means[2],      width, yerr=exact_timeStd[2],  label='E-ALLOCATOR',    color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2]+E_overlap3Means[2]+E_overlap4Means[2]+E_overlap5Means[2]+E_overlap6Means[2]+E_overlap7Means[2])
#axs[2].bar(x - width,  E_overlap9Means[2],      width, yerr=exact_timeStd[2],  label='E-ALLOCATOR',    color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[2]+E_overlap2Means[2]+E_overlap3Means[2]+E_overlap4Means[2]+E_overlap5Means[2]+E_overlap6Means[2]+E_overlap7Means[2]+E_overlap8Means[2])

axs[2].bar(x ,         M_semOverlapMeans[2],    width, yerr=M_semOverlapStd[2] ,    label='M-ALLOCATOR',    color='#15B01A', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7)
axs[2].bar(x ,         M_overlap2Means[2],      width, yerr=M_overlap2Std[2] ,                              color='#FFFF14', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2])
#axs[2].bar(x ,         M_overlap3Means[2],      width, yerr=ga_timeStd[2] ,    label='M-ALLOCATOR',    color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2])
#axs[2].bar(x ,         M_overlap4Means[2],      width, yerr=ga_timeStd[2] ,    label='M-ALLOCATOR',    color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2]+M_overlap3Means[2])
#axs[2].bar(x ,         M_overlap5Means[2],      width, yerr=ga_timeStd[2] ,    label='M-ALLOCATOR',    color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2]+M_overlap3Means[2]+M_overlap4Means[2])
#axs[2].bar(x ,         M_overlap6Means[2],      width, yerr=ga_timeStd[2] ,    label='M-ALLOCATOR',    color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2]+M_overlap3Means[2]+M_overlap4Means[2]+M_overlap5Means[2])
#axs[2].bar(x ,         M_overlap7Means[2],      width, yerr=ga_timeStd[2] ,    label='M-ALLOCATOR',    color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2]+M_overlap3Means[2]+M_overlap4Means[2]+M_overlap5Means[2]+M_overlap6Means[2])
#axs[2].bar(x ,         M_overlap8Means[2],      width, yerr=ga_timeStd[2] ,    label='M-ALLOCATOR',    color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2]+M_overlap3Means[2]+M_overlap4Means[2]+M_overlap5Means[2]+M_overlap6Means[2]+M_overlap7Means[2])
#axs[2].bar(x ,         M_overlap9Means[2],      width, yerr=ga_timeStd[2] ,    label='M-ALLOCATOR',    color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[2]+M_overlap2Means[2]+M_overlap3Means[2]+M_overlap4Means[2]+M_overlap5Means[2]+M_overlap6Means[2]+M_overlap7Means[2]+M_overlap8Means[2])

axs[2].bar(x + width,  H_semOverlapMeans[2],   width, yerr=H_semOverlapStd[2] ,  label='Heuristic',    color='#15B01A', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7)
axs[2].bar(x + width,  H_overlap2Means[2],     width, yerr=H_overlap2Std[2] ,                          color='#FFFF14', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2])
#axs[2].bar(x + width,  H_overlap3Means[2],     width, yerr=heur_timeStd[2] ,  label='Heuristic',    color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2])
#axs[2].bar(x + width,  H_overlap4Means[2],     width, yerr=heur_timeStd[2] ,  label='Heuristic',    color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2]+H_overlap3Means[2])
#axs[2].bar(x + width,  H_overlap5Means[2],     width, yerr=heur_timeStd[2] ,  label='Heuristic',    color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2]+H_overlap3Means[2]+H_overlap4Means[2])
#axs[2].bar(x + width,  H_overlap6Means[2],     width, yerr=heur_timeStd[2] ,  label='Heuristic',    color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2]+H_overlap3Means[2]+H_overlap4Means[2]+H_overlap5Means[2])
#axs[2].bar(x + width,  H_overlap7Means[2],     width, yerr=heur_timeStd[2] ,  label='Heuristic',    color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2]+H_overlap3Means[2]+H_overlap4Means[2]+H_overlap5Means[2]+H_overlap6Means[2])
#axs[2].bar(x + width,  H_overlap8Means[2],     width, yerr=heur_timeStd[2] ,  label='Heuristic',    color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2]+H_overlap3Means[2]+H_overlap4Means[2]+H_overlap5Means[2]+H_overlap6Means[2]+H_overlap7Means[2])
#axs[2].bar(x + width,  H_overlap9Means[2],     width, yerr=heur_timeStd[2] ,  label='Heuristic',    color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[2]+H_overlap2Means[2]+H_overlap3Means[2]+H_overlap4Means[2]+H_overlap5Means[2]+H_overlap6Means[2]+H_overlap7Means[2]+H_overlap8Means[2])


###   Cenário Brum3645   ###
axs[3].bar(x - width,  E_semOverlapMeans[3],    width,                         label='E-ALLOCATOR',    color='#15B01A', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7)
axs[3].bar(x - width,  E_overlap2Means[3],      width,                                                 color='#FFFF14', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3])
#axs[3].bar(x - width,  E_overlap3Means[3],      width, yerr=exact_timeStd[3],  label='E-ALLOCATOR',    color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3])
#axs[3].bar(x - width,  E_overlap4Means[3],      width, yerr=exact_timeStd[3],  label='E-ALLOCATOR',    color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3]+E_overlap3Means[3])
#axs[3].bar(x - width,  E_overlap5Means[3],      width, yerr=exact_timeStd[3],  label='E-ALLOCATOR',    color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3]+E_overlap3Means[3]+E_overlap4Means[3])
#axs[3].bar(x - width,  E_overlap6Means[3],      width, yerr=exact_timeStd[3],  label='E-ALLOCATOR',    color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3]+E_overlap3Means[3]+E_overlap4Means[3]+E_overlap5Means[3])
#axs[3].bar(x - width,  E_overlap7Means[3],      width, yerr=exact_timeStd[3],  label='E-ALLOCATOR',    color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3]+E_overlap3Means[3]+E_overlap4Means[3]+E_overlap5Means[3]+E_overlap6Means[3])
#axs[3].bar(x - width,  E_overlap8Means[3],      width, yerr=exact_timeStd[3],  label='E-ALLOCATOR',    color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3]+E_overlap3Means[3]+E_overlap4Means[3]+E_overlap5Means[3]+E_overlap6Means[3]+E_overlap7Means[3])
#axs[3].bar(x - width,  E_overlap9Means[3],      width, yerr=exact_timeStd[3],  label='E-ALLOCATOR',    color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='////', alpha=0.7, bottom=E_semOverlapMeans[3]+E_overlap2Means[3]+E_overlap3Means[3]+E_overlap4Means[3]+E_overlap5Means[3]+E_overlap6Means[3]+E_overlap7Means[3]+E_overlap8Means[3])

axs[3].bar(x ,         M_semOverlapMeans[3],    width, yerr=M_semOverlapStd[3] ,    label='M-ALLOCATOR',    color='#15B01A', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7)
axs[3].bar(x ,         M_overlap2Means[3],      width, yerr=M_overlap2Std[3] ,                              color='#FFFF14', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3])
#axs[3].bar(x ,         M_overlap3Means[3],      width, yerr=ga_timeStd[3] ,    label='M-ALLOCATOR',    color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3])
#axs[3].bar(x ,         M_overlap4Means[3],      width, yerr=ga_timeStd[3] ,    label='M-ALLOCATOR',    color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3]+M_overlap3Means[3])
#axs[3].bar(x ,         M_overlap5Means[3],      width, yerr=ga_timeStd[3] ,    label='M-ALLOCATOR',    color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3]+M_overlap3Means[3]+M_overlap4Means[3])
#axs[3].bar(x ,         M_overlap6Means[3],      width, yerr=ga_timeStd[3] ,    label='M-ALLOCATOR',    color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3]+M_overlap3Means[3]+M_overlap4Means[3]+M_overlap5Means[3])
#axs[3].bar(x ,         M_overlap7Means[3],      width, yerr=ga_timeStd[3] ,    label='M-ALLOCATOR',    color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3]+M_overlap3Means[3]+M_overlap4Means[3]+M_overlap5Means[3]+M_overlap6Means[3])
#axs[3].bar(x ,         M_overlap8Means[3],      width, yerr=ga_timeStd[3] ,    label='M-ALLOCATOR',    color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3]+M_overlap3Means[3]+M_overlap4Means[3]+M_overlap5Means[3]+M_overlap6Means[3]+M_overlap7Means[3])
#axs[3].bar(x ,         M_overlap9Means[3],      width, yerr=ga_timeStd[3] ,    label='M-ALLOCATOR',    color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='....', alpha=0.7, bottom=M_semOverlapMeans[3]+M_overlap2Means[3]+M_overlap3Means[3]+M_overlap4Means[3]+M_overlap5Means[3]+M_overlap6Means[3]+M_overlap7Means[3]+M_overlap8Means[3])

axs[3].bar(x + width,  H_semOverlapMeans[3],   width, yerr=H_semOverlapStd[3] ,  label='Heuristic',    color='#15B01A', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7)
axs[3].bar(x + width,  H_overlap2Means[3],     width, yerr=H_overlap2Std[3] ,                          color='#FFFF14', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3])
#axs[3].bar(x + width,  H_overlap3Means[3],     width, yerr=heur_timeStd[3] ,  label='Heuristic',    color='#FFA500', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3])
#axs[3].bar(x + width,  H_overlap4Means[3],     width, yerr=heur_timeStd[3] ,  label='Heuristic',    color='#F97306', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3]+H_overlap3Means[3])
#axs[3].bar(x + width,  H_overlap5Means[3],     width, yerr=heur_timeStd[3] ,  label='Heuristic',    color='#FE420F', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3]+H_overlap3Means[3]+H_overlap4Means[3])
#axs[3].bar(x + width,  H_overlap6Means[3],     width, yerr=heur_timeStd[3] ,  label='Heuristic',    color='#FF6347', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3]+H_overlap3Means[3]+H_overlap4Means[3]+H_overlap5Means[3])
#axs[3].bar(x + width,  H_overlap7Means[3],     width, yerr=heur_timeStd[3] ,  label='Heuristic',    color='#EF4026', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3]+H_overlap3Means[3]+H_overlap4Means[3]+H_overlap5Means[3]+H_overlap6Means[3])
#axs[3].bar(x + width,  H_overlap8Means[3],     width, yerr=heur_timeStd[3] ,  label='Heuristic',    color='#FF0000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3]+H_overlap3Means[3]+H_overlap4Means[3]+H_overlap5Means[3]+H_overlap6Means[3]+H_overlap7Means[3])
#axs[3].bar(x + width,  H_overlap9Means[3],     width, yerr=heur_timeStd[3] ,  label='Heuristic',    color='#E50000', edgecolor='black', linewidth=1.0, capsize=3, hatch='xxxx', alpha=0.7, bottom=H_semOverlapMeans[3]+H_overlap2Means[3]+H_overlap3Means[3]+H_overlap4Means[3]+H_overlap5Means[3]+H_overlap6Means[3]+H_overlap7Means[3]+H_overlap8Means[3])
